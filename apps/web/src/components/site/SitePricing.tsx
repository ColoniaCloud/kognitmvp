    ...
    <section className="relative overflow-hidden bg-gradient-deep px-6 py-24 text-white md:px-8">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mb-14 text-center">
          <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-primary-glow">{t("plans.eyebrow")}</p>
          <h2 className="animate-title-blur-in mt-2 text-3xl font-bold tracking-tight md:text-4xl">{t("plans.title")}</h2>
          <p className="mx-auto mt-4 max-w-2xl text-white/70">{t("plans.subtitle")}</p>
        </div>

        <div className="mx-auto grid max-w-3xl gap-6 md:grid-cols-2">
          {/* Free */}
          <div className="rounded-3xl border border-white/15 bg-white/5 p-8 backdrop-blur">
            <p className="text-sm font-bold uppercase tracking-widest text-white/60">{t("plans.free.name")}</p>
            <p className="mt-4 text-4xl font-bold">{t("plans.free.price")}</p>
            <p className="mt-1 text-sm text-white/60">{t("plans.free.priceNote")}</p>
          ...
          <div className="relative rounded-3xl border-2 border-accent bg-white/10 p-8 backdrop-blur">
            ...
            <p className="text-sm font-bold uppercase tracking-widest text-primary-glow">{t("plans.pro.name")}</p>
            <p className="mt-4 text-4xl font-bold">
              {t("plans.pro.price")}
              <span className="text-base font-medium text-white/60">{t("plans.pro.priceSuffix")}</span>
            </p>
            <p className="mt-1 text-sm text-white/60">{t("plans.pro.priceNote")}</p>
